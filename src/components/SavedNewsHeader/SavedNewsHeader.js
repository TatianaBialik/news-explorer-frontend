  ...
  return (
    <header className="saved-header">
      ...
      <div className="saved-header__info">
        ...
        <p className="saved-header__keywords-block">By keywords: <span className="saved-header__keywords">{articles[0].keyword}, {articles[1].keyword}, and {articles.length-2} other</span></p>
      </div>
    </header>
  )
};
